...
| `hasFirstTurnStarted` | CLAUDE-ONLY (unverified detail) | `[grep]` | Name/location suggest Claude turn-tracking; not individually read — flagged for a closer look before relying on it for codex. |
