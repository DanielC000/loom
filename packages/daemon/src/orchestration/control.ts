 ...
 *
 * @decision sha:0db42b7f — in-memory is deliberate: resetting to "not paused" on daemon restart is
 * the SAFE failure, since a restart means nothing is spawning yet and there is no in-flight loop
 * left to bound.
 *
