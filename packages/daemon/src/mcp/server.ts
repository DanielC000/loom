  ...
  private buildServer(projectId: string, sessionId: string, attributions?: Map<string, ToolAttributionResult>): McpServer {
    ...
    server.registerTool(
      ...
      async ({ id, taskId, fields }) => {
        ...
        const spilled = spillableTaskGet(sessionId, "tasks-get-spills", result.id, result);
