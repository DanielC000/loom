    ...
    server.registerTool(
      "my_context",
      {
        description:
          ...
          "message may never have actually landed; one Enter in your terminal recovers it. If you are a " +
