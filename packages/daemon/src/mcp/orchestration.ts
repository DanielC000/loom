    ...
    server.registerTool(
      "my_context",
      {
        description:
          ...
          "worker) recovers a genuinely stranded one. ⚠️ NOT decisive alone (card d4b3fa6c): a GIVE-UP " +
