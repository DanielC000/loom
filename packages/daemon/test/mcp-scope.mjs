...
// tasks_* (the project-scoped board) + wake_* (the self-scheduled wake_me primitive) + memory_* (the
...
const expectedTaskTools = "memory_forget,memory_list,memory_read,memory_write,task_request_get,task_requests_list,tasks_create,tasks_get,tasks_list,tasks_update,wake_cancel,wake_list,wake_me";
