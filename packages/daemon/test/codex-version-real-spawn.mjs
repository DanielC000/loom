...
if (process.platform !== "win32") {
  ...
  console.log("WARN  SKIP  codex-version-real-spawn.mjs — the .cmd-wrapper fixture mechanism this file uses is Windows-only (process.platform !== 'win32' here); see kickoff-real-spawn.mjs's header for the accepted POSIX gap this mirrors.");
  process.exit(0);
}
